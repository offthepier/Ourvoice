...
import { CreatePostReqSchema } from "src/helpers/validators/schemas/NewPostRequestValidation.schema";
export const handler: Handler = middify(
  async (
    ...
    try {
      const post = await PetitionService.createPost({
...
).use(requestValidator({ body: CreatePostReqSchema }));
