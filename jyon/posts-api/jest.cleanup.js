...
export const teardown = async () => {
  ...
  //Table names
  const postTableName = process.env.POSTS_TABLE || "prod-Posts";
  const commentTableName = process.env.COMMENTS_TABLE || "prod-Comments";
  const challengesTableName = process.env.CHALLENGES_TABLE || "prod-Challenges";
